    ...
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
      ...
      <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
        ...
        <button
          ...
          className="bg-primary hover:bg-primary-dull rounded-full px-10 py-3 transition cursor-pointer
          font-medium text-sm active:scale-95 flex items-center gap-1 mt-10"
        >
          Proceed to Checkout
