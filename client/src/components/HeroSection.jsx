...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <button onClick={()=>navigate("/movies")} className="flex items-center gap-1 bg-primary hover:bg-primary-dull transition duration-300 rounded-full
